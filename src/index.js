...
export default class RNPickerSelect extends PureComponent {
    ...
    getPlaceholderStyle() {
        const { placeholder, placeholderTextColor, style, value } = this.props;

        if (!isEqual(placeholder, {}) && this.state.selectedItem.label === placeholder.label && !value) {
            return {
    ...
    renderTextInputOrChildren() {
        const { children, style, textInputProps, value } = this.props;
        ...
        return (
            <View pointerEvents="box-only" style={containerStyle}>
                <TextInput
                    ...
                    // value={this.state.selectedItem.label}
                    value={value ? value : this.state.selectedItem.label}
                    ref={this.setInputRef}
                    editable={false}
                    {...textInputProps}
                />
